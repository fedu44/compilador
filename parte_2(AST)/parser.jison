...
'FUNC'              console.log("LEXEMA = "+yytext); yy.can_return_value=true; return 'FUNC';
'PROC'              console.log("LEXEMA = "+yytext); yy.can_return_value=false; return 'PROC';
...
program
    : "PROGRAM" ID ";" definiciones EOF
        { 
            ...
            //console.log("$3", $3)
            //$$ = ' '.concat($1,$2,$3,$4);
            //const block = new yy.block("Bloque", $3, true);
            //const programa = new yy.program("Programa", block);
            return ' '.concat($1,$2,$3); 
        }
    ;
...
definiciones
    : definicion definiciones
        {
            console.log('Regla 1.1 definiciones-> definicion definiciones');
            $2.push($1);
            $$ = $2
        }
    | definicion
        {
            console.log('Regla 1.2 definiciones-> definicion');
            $$ = [$1]
        }
    ;
...
definicion
    : def_variable ';'
        { 
            console.log('Regla 2.1 definicion-> def_variable;'); 
            $$ = $1;
        }
    | def_funcion
...
def_variable
    : VAR ID ":" data_type
        { 
            console.log('Regla 4.1 def_variable-> VAR ID : data_type');
            $$ = new yy.asignacion(new yy.identificador($2,$4))
        }
    | VAR ID ":" data_type "<-" e
        { 
            console.log('Regla 4.2 def_variable-> VAR ID : data_type <- e');
            $$ = new yy.asignacion(new yy.identificador($2,$4), $6)
        }
    | CONST ID ":" data_type "<-" e
        { 
            console.log('Regla 4.3 def_variable-> CONST ID : data_type <- e');
            $$ = new yy.constante($2, $4, $6)
            yy.stack.array.pop(); 
        }
    ;
...
sentencias
    : sentencia ';' sentencias  
        {
            console.log('Regla 9.1 sentencias-> sentencia ; sentencias');
            $2.push($1);
            $$ = $2;
        }
    | sentencia ';'
        {
            console.log('Regla 9.2 sentencias-> sentencia;');
            $$ = [$1];
        }
    ;
...
sentencia
    ...
    | sentencia_una_linea
        {
            console.log('Regla 10.5 sentencia-> sentencia_una_linea');
            $$ = $1;
        }
    ;
...
sentencia_una_linea
    : ID "<-" e
        { 
            console.log('Regla 12.1 sentencia_una_linea-> ID <- e');
            $$ = new yy.asignacion(new yy.identificador($1), $3)
        }
    | RETURN e 
...
e 
    : e '||' ela
        {
            console.log('Regla 23.1 e-> ela || el');
            $$ = new yy.arigOp($1, $3, $2)
        }
    | ela
        {
            console.log('Regla 23.2 e-> ela');
            $$ = $1;
        }
    | ea
        {
            console.log('Regla 23.3 e-> ea');
            $$ = $1;
        }
    ;
...
ela
    : ela '&&' eld
        {
            console.log('Regla 24.1 ela-> ela && eld');
            $$ = new yy.arigOp($1, $3, $2)
        }
    | eld
        {
            console.log('Regla 24.2 ela-> eld');
            $$ = $1;
        }
    ;
...
eld
    : '!' eld
        {
            console.log('Regla 25.1 eld-> ! eld');
            $$ = new yy.operacionUnaria("!", $2);
        }
    | comparacion
        {
            console.log('Regla 25.2 eld-> comparacion'); 
            $$ = $1;
        }
    ;
...
comparacion
    : ea "<=" ea
        {
            console.log('Regla 26.1 comparacion-> e "<=" e');
            $$ = new yy.arigOp($1, $3, $2)
        }
    | ea ">=" ea
        {
            console.log('Regla 26.2 comparacion-> e ">=" e');
            $$ = new yy.arigOp($1, $3, $2)
        }
    | ea "<" ea
        {
            console.log('Regla 26.3 comparacion-> e "<" e');
            $$ = new yy.arigOp($1, $3, $2);
        }
    | ea ">" ea
        {
            console.log('Regla 26.4 comparacion-> e ">" e');
            $$ = new yy.arigOp($1, $3, $2);
        }
    | ea "==" ea
        {
            console.log('Regla 26.5 comparacion-> e "==" e');
            $$ = new yy.arigOp($1, $3, $2);
        }
    | ea "<>" ea
        {
    ...
    | 'TRUE'
        {
            console.log('Regla 26.6 comparacion-> true');
            $$ = yy.tipo.BOOL
        }
    | 'FALSE'
        {
            console.log('Regla 26.7 comparacion-> false');
            $$ = yy.tipo.BOOL
        }
    ;
...
ea
    : ea '+' t
        {
            console.log('Regla 27.1 ea-> ea + t');
            $$ = new yy.arigOp($1, $3, $2)
        }
    | ea '-' t
		{
            console.log('Regla 27.2 ea-> ea - t');
            $$ = new yy.arigOp($1, $3, $2)
        }
    | t
		{
            console.log('Regla 27.3 e-> t');
            $$ = $1;
        }
    ;
...
t
    : t '*' f
        {
            console.log('Regla 28.1 t-> t * f');
            $$ = new yy.arigOp($1, $3, $2)
        }
    | t '/' f
		{
            console.log('Regla 28.2 t-> t / f');
            $$ = new yy.arigOp($1, $3, $2)
        }
    | f
		{
            console.log('Regla 28.3 t-> f');
            $$ = $1
        }
    ;
...
f
    : '-' f
        {
            console.log('Regla 29.1 f-> -f');
            $$ = new yy.arigOp(0, $2, $1)
        }
    | fs
		{
            console.log('Regla 29.2 f-> fs');
            $$ = $1
        }
    ;
...
fs
    : INT
		{
            console.log('Regla 30.1 fs-> NUMBER');
            $$ = yy.tipo.INTEGER
        }
	| id_or_functionCall
    ...
    | FLOAT
        {
            console.log('Regla 30.3 fs-> FLOAT');
            $$ = yy.tipo.FLOAT
        }
    | '(' e ')'
		{
            console.log('Regla 30.4 e-> ( e )');
            $$ = $2;
        }
    ;
...
id_or_functionCall
    ...
    | ID 
        {
            console.log('Regla 31.2 id_or_functionCall-> ID');
            $$ = new yy.identificador($1);
        }
    ;
